...
function Links() {
  ...
  return React8.createElement(React8.Fragment, null, typeof criticalCss === "string" ? React8.createElement(
    ...
    ({ key, link }) => isPageLinkDescriptor(link) ? React8.createElement(PrefetchPageLinks, { key, ...link }) : React8.createElement("link", { key, ...link })
  ));
}
...
function RSCStaticRouter({ getPayload }) {
  const payload = React52.use(getPayload());
  if (payload.type === "redirect") {
    throw new Response(null, {
      status: payload.status,
      headers: {
